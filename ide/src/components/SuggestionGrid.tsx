...
function SuggestionGrid() {
  return (
    <section 
      className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-12 w-full max-w-5xl px-4 opacity-40 hover:opacity-100 transition-opacity duration-500" 
    ...
    >
      {suggestions.map((suggestion) => (
        ...
        >
          <span className={`material-symbols-outlined ${suggestion.tone} block mb-2 text-[20px]`}>
            {suggestion.icon}
          </span>
